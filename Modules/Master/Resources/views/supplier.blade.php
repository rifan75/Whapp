  ...
  <div class="row">
    <div class="col-md-8">
      <div class="box">
        ...
        <div class="box-body">
          <form method="post" id="formsupplier">
    ...
    <div class="col-md-4">
      <div class="box">
        <div class="box-header">
          <h3 id="suppliertitle" class="box-title">Input Supplier</h3>
        </div>
        <div class="box-body">
            <div class="container-fluid">
            <form id="supplierform" action="{{ url('master/supplier') }}" method="post" data-toggle="validator">
              @csrf
                ...
                <div class="row">
	                <div class="form-group col-md-12">
	            		<input id="submit" type="submit" class="form-control btn btn-primary prod-submit" value="Add Supplier">
	                </div>
                </div>
            </form>
            </div>
...
function editForm(id){
    ...
    $.ajax({
      url : "/master/supplier/"+id+"/edit",
      type : "GET",
      dataType : "JSON",
      success : function(data){
        $('#suppliertitle').text('Edit Supplier');
        $('#submit').val('Edit Supplier');
        $('#name').val(data.name);
				...
				$('#note').val(data.note);
        $('#supplierform').attr('action', 'supplier/'+id);
      },
      error : function() {
