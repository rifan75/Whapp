		...
		<div class="box">
			<div class="box-body">
				...
				<table id="inventorytable" class="table table-bordered table-hover">
					<input  id="model" type="hidden" name='model' value="Send">
					<thead>
					<tr>
						<th style="text-align:center">Id</th>
						<th style="text-align:center">No Letter</th>
            ...
            <tr>
               ...
               <td>{{ $data->no_letter }}</td>
							 <td>{{ count($data->warehousefrom)==0 ? "No Warehouse/ Data Deleted" : $data->warehousefrom->name }}</td>
