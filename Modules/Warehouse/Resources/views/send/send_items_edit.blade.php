...
<section class="content-header">
    <h1>Pengiriman Barang {{$lokasi->warehouse_name}}<small>&nbsp;<span id="waktu"></span></small></h1>
    <ol class="breadcrumb">
            ...
            <div class="row">
                <!-- <div class="col-md-3">
                    <table id="tambahskutable" class="table table-hover">
                      <input id="idtab" type="hidden" value="{{$lokasi->id}}">
...
@include('persediaan.kirim.contentkirimeditbarang')
            </div>
          </div>
        </div>
      </div>
